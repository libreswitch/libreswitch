...
# with the OVS infrastructure used by LibreSwitch.
...
do_install_append() {
    ...
    # from LibreSwitch switchd process
    ...
    echo "d /run/openvswitch-sim/ - - - -" > ${D}${sysconfdir}/tmpfiles.d/libreswitch-sim.conf
}
