...
IMAGE_FEATURES[validitems] += "debug-tweaks vagrant-tweaks read-only-rootfs"
...
ROOTFS_POSTPROCESS_COMMAND += '${@bb.utils.contains("IMAGE_FEATURES", "vagrant-tweaks", "vagrant_support; ", "",d)}'
# For vagrant disable SSH DNS lookup
ROOTFS_POSTPROCESS_COMMAND += '${@bb.utils.contains("IMAGE_FEATURES", "vagrant-tweaks", "ssh_disable_dns_lookup; ", "",d)}'
