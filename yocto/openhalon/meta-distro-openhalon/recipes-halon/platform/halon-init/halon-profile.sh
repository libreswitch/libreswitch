...
alias swnssh="/sbin/ip netns exec swns /bin/bash --rcfile /etc/profile.d/halon-profile -i"
alias swnspids="/sbin/ip netns pids swns"

# Shortcuts for "nonet" network namespace commands
alias nonet="/sbin/ip netns exec nonet"
alias nonetssh="/sbin/ip netns exec nonet /bin/bash --rcfile /etc/profile.d/halon-profile -i"
